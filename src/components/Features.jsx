...
export default function Features() {
  const items = [
    ...
    },
    {
      ...
      desc: "Colorful illustrations and light interactivity to keep curious minds engaged.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="group bg-white/80 backdrop-blur rounded-2xl p-6 ring-1 ring-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-transform">
                <Icon size={22} />
              </div>
